...
export OPD_MM_VERIFIER_BASE_URL=${OPD_MM_VERIFIER_BASE_URL:-http://192.168.1.113:31208}
export OPD_MM_VERIFIER_MODEL=${OPD_MM_VERIFIER_MODEL:-Qwen3.5-9B}
export OUTCOME_SERVER_BASE_URL=${OUTCOME_SERVER_BASE_URL:-http://192.168.1.113:31208}
...
export DISTILLATION_TOPK=${DISTILLATION_TOPK:-8}
