...
export BEST_CHECKPOINT_METRIC=${BEST_CHECKPOINT_METRIC:-opd_mm/answer_correct/mean@1}
export BEST_CHECKPOINT_MODE=${BEST_CHECKPOINT_MODE:-max}
export OPSD_TRAJECTORY_NORMALIZE=${OPSD_TRAJECTORY_NORMALIZE:-True}
export OPSD_NO_PUBLIC_EVIDENCE_MAX_FRACTION=${OPSD_NO_PUBLIC_EVIDENCE_MAX_FRACTION:-0.30}
