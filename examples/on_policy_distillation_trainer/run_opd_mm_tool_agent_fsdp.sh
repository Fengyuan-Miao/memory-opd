...
experiment_name=${EXPERIMENT_NAME:-opd_mm_qwen35_4b_frozen_teacher_queryrewrite_promptfix_${RUN_TIMESTAMP}}

LOG_DIR=${LOG_DIR:-logs}
TRAIN_LOG_PATH=${TRAIN_LOG_PATH:-${LOG_DIR}/${experiment_name}.log}
OPD_MM_STUDENT_ROLLOUT_DUMP_DIR=${OPD_MM_STUDENT_ROLLOUT_DUMP_DIR:-${LOG_DIR}/opd_mm_student_rollouts_queryrewrite_promptfix_${RUN_TIMESTAMP}}
OPD_MM_STUDENT_ROLLOUT_DUMP_MAX_CHARS=${OPD_MM_STUDENT_ROLLOUT_DUMP_MAX_CHARS:-12000}
OPD_MM_TEACHER_CORRECTION_DUMP_DIR=${OPD_MM_TEACHER_CORRECTION_DUMP_DIR:-${LOG_DIR}/opd_mm_teacher_corrections_queryrewrite_promptfix_${RUN_TIMESTAMP}}
...
OPD_MM_RAW_INSPECTOR_MODEL=${OPD_MM_RAW_INSPECTOR_MODEL:-}
